...
from app.api.v1.endpoints import login, users, roles, menus, logs, messages, dashboard, exchange, market, trade, strategy, trade_records, positions, performance, risk_config, signals, reduce_short, backtest, stream, news, bitget_rwa, bitget_futures
...
api_router.include_router(news.router, prefix="/news", tags=["币圈新闻"])
api_router.include_router(bitget_rwa.router, prefix="/bitget-rwa", tags=["Bitget RWA"])
api_router.include_router(bitget_futures.router, prefix="/bitget-futures", tags=["Bitget Futures"])
